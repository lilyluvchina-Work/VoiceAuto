...
assert.equal(spoken.config.voiceType, 'en_female_skye_emo_v2_mars_bigtts');
...
assert.equal(spoken.config.voiceType, 'zh_female_shuangkuaisisi_moon_bigtts');
assert.equal(spoken.config.voiceName, '爽快思思');
assert.equal(spoken.config.voice, 'zh_female_shuangkuaisisi_moon_bigtts');
